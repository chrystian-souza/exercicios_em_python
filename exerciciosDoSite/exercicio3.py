...
ganhoPorHora = float(input('Informe os seus ganhos por hora: '))
numHorastrab = float(input('Informe o número de horas trabalhadas no mês: '))
calc = ganhoPorHora * numHorastrab
print(calc)